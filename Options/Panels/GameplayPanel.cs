...
namespace YAVSRG.Options.Panels
{
    class GameplayPanel : OptionsPanel
    {
        public GameplayPanel(InfoBox ib, LayoutPanel lp) : base(ib, "Gameplay")
        {
            ...
            AddChild(
                new TooltipContainer(
                new TextPicker("Score System", new string[] { "Default", "Osu", "DP", "Wife" }, (int)Game.Options.Profile.ScoreSystem, v => { Game.Options.Profile.ScoreSystem = (IScoreSystem.ScoreType)v; }),
