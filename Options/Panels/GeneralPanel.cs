...
namespace YAVSRG.Options.Panels
{
    ...
    {
        public GeneralPanel(InfoBox ib) : base(ib,"General")
        {
            AddChild(
                ...
                .PositionTopLeft(-200, 50, AnchorType.CENTER, AnchorType.MIN)
                .PositionBottomRight(200, 75, AnchorType.CENTER, AnchorType.MIN));
            AddChild(
                new TooltipContainer(
                ...
                .PositionTopLeft(-200, 150, AnchorType.CENTER, AnchorType.MIN)
                .PositionBottomRight(200, 175, AnchorType.CENTER, AnchorType.MIN));
            AddChild(
                new TooltipContainer(
                ...
                .PositionTopLeft(-200, 250, AnchorType.CENTER, AnchorType.MIN)
                .PositionBottomRight(-50, 275, AnchorType.CENTER, AnchorType.MIN));
            AddChild(
                new TooltipContainer(
                ...
                .PositionTopLeft(50, 250, AnchorType.CENTER, AnchorType.MIN)
                .PositionBottomRight(200, 275, AnchorType.CENTER, AnchorType.MIN));
            AddChild(
                new TooltipContainer(
            ...
            AddChild(
                new TooltipContainer(
                    new FramedButton("buttonbase", "Change profile", () => { Game.Screens.AddDialog(new ProfileDialog((s) => { })); }),
            ...
            .PositionTopLeft(0, 100, AnchorType.MIN, AnchorType.MAX)
