    ...
    class GameplayPanel : Widget
    {
        public GameplayPanel()
        {
            AddChild(
                ...
                .TL_DeprecateMe(-300, 100, AnchorType.CENTER, AnchorType.MIN)
                .BR_DeprecateMe(-50, 150, AnchorType.CENTER, AnchorType.MIN));
            AddChild(
                new TooltipContainer(
                ...
                .TL_DeprecateMe(50, 100, AnchorType.CENTER, AnchorType.MIN)
                .BR_DeprecateMe(300, 150, AnchorType.CENTER, AnchorType.MIN));
            AddChild(
                new TooltipContainer(
                ...
                .BR_DeprecateMe(-50, 225, AnchorType.CENTER, AnchorType.MIN));
            AddChild(
                new TooltipContainer(
                ...
                .BR_DeprecateMe(300, 225, AnchorType.CENTER, AnchorType.MIN));
            AddChild(
                new TooltipContainer(
                ...
                .BR_DeprecateMe(-50, 325, AnchorType.CENTER, AnchorType.MIN));
            AddChild(
                new TooltipContainer(
                ...
                .BR_DeprecateMe(300, 325, AnchorType.CENTER, AnchorType.MIN));
            AddChild(
                new TooltipContainer(
