...
type MainMenuScreen() as this =
    ...
    override this.Draw() =
        ...
        Text.drawJustB (Style.font, ss, 20.0f, c, this.Bounds.Top + 50.0f + 30.0f * splashSubAnim.Value, (Color.FromArgb (a1, Color.White), Style.color (a1, 0.5f, 0.0f)), 0.5f)
        Text.drawJustB (Style.font, s, 40.0f, c, this.Bounds.Top - 60.0f + 80.0f * splashAnim.Value, (Color.FromArgb (a2, Color.White), Style.color (a2, 0.5f, 0.0f)), 0.5f)
        base.Draw()
