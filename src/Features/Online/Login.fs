...
type RegisterPage(discord_tag) as this =
    ...
    do
        this.Content(
            ...
            |+ PageButton("register.terms_of_service", fun () -> open_url("https://yavsrg.net/terms_of_service")).Pos(650.0f)
            |+ PageButton("register.privacy_policy", fun () -> open_url("https://yavsrg.net/privacy_policy")).Pos(720.0f)
