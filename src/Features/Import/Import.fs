...
type ImportScreen() as this =
    ...
    let tabs = 
        ...
        |+ TabButton(Icons.import_local, L"imports.local.name", ImportScreen.container, Mounts.tab)
        |+ TabButton(Icons.import_etterna, L"imports.etterna_packs.name", ImportScreen.container, EtternaPacks.tab)
        |+ TabButton(Icons.import_osu, L"imports.beatmaps.name", ImportScreen.container, Beatmaps.tab)
        |+ TabButton(Icons.import_noteskin, L"imports.noteskins.name", ImportScreen.container, Noteskins.tab)
        |+ TabButton(Icons.gameplay, L"imports.rulesets.name", ImportScreen.container, Rulesets.tab)
        |+ TabButton(Icons.table, L"imports.tables.name", ImportScreen.container, Tables.tab)
