    ...
    do
        this.Content(
            ...
            |+ PageSetting("themes.editnoteskin.noteskinname", TextEntry(name, "none"))
                .Pos(100.0f)
            |+ PageSetting("themes.editnoteskin.holdnotetrim", Slider(holdNoteTrim))
                .Pos(170.0f)
            ...
            |+ PageSetting("themes.editnoteskin.columnwidth", Slider(columnWidth, Step = 1f))
                .Pos(310.0f)
                .Tooltip(Tooltip.Info("themes.editnoteskin.columnwidth"))
            |+ PageSetting("themes.editnoteskin.columnspacing",Slider(columnSpacing, Step = 1f))
                .Pos(390.0f)
