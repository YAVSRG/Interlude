...
namespace YAVSRG.Interface.Widgets.Toolbar
{
    public class ProfileInfoPanel : ToolbarWidget
    {
        ...
        {
            base.Draw(bounds);
            float x = Math.Max(250, Math.Min(800, SpriteBatch.Font1.MeasureText(Game.Options.Profile.Name, 40))) + 90;
            ...
            SpriteBatch.Font1.DrawJustifiedText(Utils.RoundNumber(Game.Options.Profile.Stats.PhysicalMean[Game.CurrentChart.Keys - 3]), 30f, bounds.Left + x, bounds.Bottom - 80, Game.Options.Theme.MenuFont, true, Utils.PhysicalColor(Game.Options.Profile.Stats.PhysicalMean[Game.CurrentChart.Keys - 3]));
            SpriteBatch.Font1.DrawJustifiedText(Utils.RoundNumber(Game.Options.Profile.Stats.TechnicalMean[Game.CurrentChart.Keys - 3]), 30f, bounds.Left + x, bounds.Bottom - 45, Game.Options.Theme.MenuFont, true, Utils.PhysicalColor(Game.Options.Profile.Stats.TechnicalMean[Game.CurrentChart.Keys - 3]));
        ...
        public override void Update(Rect bounds)
        {
            ...
            {
                Game.Screens.AddDialog(new Dialogs.ProfileDialog((s) => { Content.ClearStore(); }));
            }
        }
    }
}
